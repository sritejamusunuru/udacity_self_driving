...
bool compare_f_values(RouteModel::Node* node1, RouteModel::Node* node2)
{
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    auto present_node = current_node;
    while(present_node != start_node)
    {
      path_found.push_back(*present_node);
      distance += present_node->distance(*(present_node->parent));
